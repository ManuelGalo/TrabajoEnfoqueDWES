    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('tienda.category', ['category' => 'deporte'])" :active="request()->routeIs('deporte')">
                        {{ __('Deporte') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('tienda.category', ['category' => 'casual'])" :active="request()->routeIs('casual')">
                        {{ __('Casual') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('tienda.category', ['category' => 'botas'])" :active="request()->routeIs('botas')">
                        {{ __('Botas') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-500 hover:text-gray-700">Entrar</a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-500 hover:text-gray-700">Registro</a>
                    </div>
                @endauth
            </div>
